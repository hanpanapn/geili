  ...
  <div class="cardshadow roleListTable">
    <div>
      <el-button
        ...
        @click="addRole"
        plain
        v-role-btn="'btn_100002'"
      >新增</el-button>
    </div>
    <el-table :data="tableData" style="width: 100%" border>
      <el-table-column type="index"></el-table-column>
      <el-table-column property="name" label="角色名"></el-table-column>
      <el-table-column property="describe" label="角色描述"></el-table-column>
    ...
    <el-dialog title="角色信息" width="700px" class="dialog1" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="角色名称" :label-width="formLabelWidth">
          <el-input v-model="form.name" maxlength="8" show-word-limit autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="角色描述" :label-width="formLabelWidth">
          <el-input v-model="form.describe" maxlength="15" show-word-limit autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    setRoleData() {
      this.$request
        .fetchSearchRolePermissions({ rid: this.selectRoleId })
        .then((res) => {
          this.$refs.permission.setCheckedKeys([]);
          let permissionData =
            res.data.data.permissionPage + "," + res.data.data.permissionButton;
